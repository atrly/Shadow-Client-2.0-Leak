...
public class GuiAnimations extends GuiScreen {
    ...
    protected String screenTitle = "Animation Settings";
	...
	public GuiAnimations(GuiScreen parentScreenIn, GameSettings gameSettingsIn) {
	 ...
	 */
	public void initGui() {
		this.screenTitle = I18n.format("Animation Settings", new Object[0]);
