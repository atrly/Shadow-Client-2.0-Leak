...
public class RenderEnv
{
    ...
    private static int breakingAnimation = -1;
    ...
    private static ThreadLocal<RenderEnv> threadLocalInstance = new ThreadLocal<RenderEnv>();

    public RenderEnv(IBlockState p_i94_2_)
    {
        //this.blockAccess = p_i94_1_;
        this.blockState = p_i94_2_;
        //this.blockPos = p_i94_3_;
        //this.gameSettings = new GameSettings(Minecraft.getMinecraft());
    }
    ...
    public static boolean isBreakingAnimation(List<?> p_isBreakingAnimation_1_) {
        if (breakingAnimation < 0 && p_isBreakingAnimation_1_.size() > 0) {
    ...
    public static boolean isBreakingAnimation(BakedQuad p_isBreakingAnimation_1_) {
    ...
    public static boolean isBreakingAnimation() {
        return breakingAnimation == 1;
    }
